        ...
        <div className="max-w-4xl mx-auto text-center border border-white/10 bg-white/[0.02] backdrop-blur-xl rounded-[1.5rem] p-8 md:p-20 relative overflow-hidden group">
          <div>
            ...
            <Link href="/consultation">
              <button
                className="group relative cursor-pointer px-6 py-3 md:px-12 md:py-6 rounded-full bg-primary text-secondary font-black text-sm md:text-xl tracking-wide transition-all duration-300 flex items-center gap-2 md:gap-4 mx-auto"
              >
